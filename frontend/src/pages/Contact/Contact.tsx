                        ...
                        <div className="flex flex-wrap">
                            <div className=" md-992:w-7/12 w-full md:pr-[30px] sm:pr-[10px] pr-[5px]">
                                <div className="contact-form-wrapper-1">
                                    <h3 className="title mb--50 animate-in fade-in-0 md:leading-[20px] leading-[35px] mb-[50px] font-bold text-[26px] text-secondary">{t("pages.contactFormTitle")}</h3>
                                    <ContactForm/>
                                </div>
                            </div>
