                    ...
                    <div className="col-xl-8 col-lg-8 col-md-12">
                                    ...
                                    <div className="details-product-area">
                                        <div className="product-thumb-area">
                                            ...
                                            <div className="thumb-wrapper one filterd-items figure">
                                                <div className="product-thumb zoom"><img src="assets/images/shop/01.jpg" alt="product-thumb"/>
                                                </div>
                                            </div>
                                            <div className="thumb-wrapper two filterd-items hide">
                                                <div className="product-thumb zoom"><img src="assets/images/shop/02.jpg" alt="product-thumb"/>
                                                </div>
                                            </div>
                                            <div className="thumb-wrapper three filterd-items hide">
                                                <div className="product-thumb zoom"><img src="assets/images/shop/03.jpg" alt="product-thumb"/>
                                                </div>
                                            </div>
                                            <div className="thumb-wrapper four filterd-items hide">
                                                <div className="product-thumb zoom" ><img src="assets/images/shop/04.jpg" alt="product-thumb"/>
                                                </div>
                                            </div>
                                            <div className="thumb-wrapper five filterd-items hide">
                                                <div className="product-thumb zoom"><img src="assets/images/shop/05.jpg" alt="product-thumb"/>
                                                </div>
                                            </div>
                                        ...
                                        <div className="contents">
                                            ...
                                            <span className="product-price mb--15 d-block"> $36.25<span className="old-price ml--15">$69.35</span></span>
                                            <div className="product-bottom-action">
                                                ...
                                                <a href="#" onClick={(e)=>e.preventDefault()} className="rts-btn btn-primary ml--20"><i className="fa-light fa-heart"></i></a>
                                            </div>
                                            <div className="product-uniques">
                                                <span className="sku product-unipue mb--10"><span >SKU: </span> BO1D0MX8SJ</span>
                                                <span className="catagorys product-unipue mb--10"><span>Categories: </span> T-Shirts, Tops, Mens</span>
                                                <span className="tags product-unipue mb--10"><span>Tags: </span> fashion, t-shirts, Men</span>
                                                <span className="tags product-unipue mb--10"><span>LIFE:: </span> 6 Months</span>
                                                <span className="tags product-unipue mb--10"><span>Type: </span> original</span>
                                                <span className="tags product-unipue mb--10"><span>Category: </span> Beverages, Dairy &amp; Bakery</span>
                                            </div>
                        ...
                        <div className="product-discription-tab-shop mt--50">
                            ...
                            <div className="tab-content" id="myTabContent">
                                ...
                                <div className="tab-pane fade" id="profile-tab-panes">
                                    <div className="single-tab-content-shop-details">
